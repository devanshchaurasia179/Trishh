...
import NoRecommendationsFound from '../components/NoRecommendationsFound.jsx';
    ...
    <div className='container mx-auto space-y-10'>
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <section>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="opacity-70">
                  Discover perfect skill exchange partners based on your profile
                </p>
              </div>
            </div>
          </div>
          ...
          ):recommendedUser.length===0?(<NoRecommendationsFound/>):(
            <>
                    ...
                    <div key={user._id} className='card bg-base-200 hover:shadow-lg transition-all duration-300'>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        <span className="badge badge-secondary">
                          ...
                          Expertise: {capitialize(user.expertise)}
                        </span>
                        <span className="badge badge-outline">
                        Learning: {capitialize(user.learningGoals)}
                        </span>
                      </div>
